	...
	<div class="center">
           ...
           <c:import url="left.jsp" /> 
            ...
            <div class="content">
                ...
                <center><h3>Current games</h3></center>
                <center><a href="${pageContext.request.contextPath}/refresh">refresh</a></center>
                <c:set var="alphabet" value="${['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j']}" scope="page"></c:set>

                <c:forEach var="game" items="${battle.currentUserGames}">
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${((battle.currentUser.login.equals(game.players[0].login))&&(game.fields[0]==null))||
                                      ...
                                      <div class="place_button">
                                          <center><a href="${pageContext.request.contextPath}/place-ships/${battle.currentUser.login.equals(game.players[0].login)?game.players[1].login:game.players[0].login}">Place ships</a></center>
                                      </div>
                                </c:if>
                            </c:otherwise>
                        </c:choose>
